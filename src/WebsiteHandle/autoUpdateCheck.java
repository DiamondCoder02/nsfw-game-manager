...
public class autoUpdateCheck {
	...
	public static Boolean checkUpdate() {
		...
		onlineLocation = getOnlineLocation(url); if (onlineLocation == null) { return success; }
		...
		if (!onlineVersion.equals(currentVersion)) { success = true; }
		System.out.println("Update is needed: "+success);
		return success;
	}
