...
public class checkMissingSetting {
	...
	public static void checkSettings() {
		...
		String folderLocation = "null", language = "english", appVersion = mainInit.appVersion;
		String[] showncolumns = {
		...
		Document dom = _folderHandle.loadSaveGamesSettings.saveLoadDoc.loadDocument(mainInit.settingsPath);
		if (dom == null) {
		} else {
			try {
	...
	private static Boolean checkings(NodeList setting, String[] somethingSettings, Document dom, String settingName) {
		...
		_folderHandle.loadSaveGamesSettings.saveLoadDoc.saveDocument(dom, mainInit.settingsPath);
